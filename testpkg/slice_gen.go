...
func (s *Slice) MarshalBinaryTo(w io.Writer) (err error) {
	...
	err = readwrite.Write_bytes(_w, _b, s.Uint8)
	if err != nil {
		return
	}
...
func (s *SlicePtr) MarshalBinaryTo(w io.Writer) (err error) {
	...
	err = readwrite.Write_bool(_w, _b, s.Bool == nil)
	if err != nil {
		return
	}
	if s.Bool != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Int == nil)
	if err != nil {
		return
	}
	if s.Int != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Int8 == nil)
	if err != nil {
		return
	}
	if s.Int8 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Int16 == nil)
	if err != nil {
		return
	}
	if s.Int16 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Int32 == nil)
	if err != nil {
		return
	}
	if s.Int32 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Int64 == nil)
	if err != nil {
		return
	}
	if s.Int64 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Uint == nil)
	if err != nil {
		return
	}
	if s.Uint != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Uint8 == nil)
	if err != nil {
		return
	}
	if s.Uint8 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Uint16 == nil)
	if err != nil {
		return
	}
	if s.Uint16 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Uint32 == nil)
	if err != nil {
		return
	}
	if s.Uint32 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Uint64 == nil)
	if err != nil {
		return
	}
	if s.Uint64 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Complex64 == nil)
	if err != nil {
		return
	}
	if s.Complex64 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Complex128 == nil)
	if err != nil {
		return
	}
	if s.Complex128 != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.String == nil)
	if err != nil {
		return
	}
	if s.String != nil {
	...
	err = readwrite.Write_bool(_w, _b, s.Maps == nil)
	if err != nil {
		return
	}
	if s.Maps != nil {
